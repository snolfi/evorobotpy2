...
static int __Pyx_modinit_type_init_code(void) {
  ...
  if (PyObject_SetAttrString(__pyx_m, "PyEvonet", (PyObject *)&__pyx_type_3net_PyEvonet) < 0) __PYX_ERR(1, 23, __pyx_L1_error)
...
static int __pyx_pymod_exec_net(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init net", 0, __pyx_lineno, __pyx_filename);
    }
